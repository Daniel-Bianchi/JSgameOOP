...
// Dimensionner le canvas à la taille du desktop
canvas.width = innerWidth;
canvas.height = innerHeight;

// Eléments du DOM pour UI
...
class Entity {
  ...
  // Méthode pour créer un disque dans le canvas
  draw() {
    ctx.beginPath();
...
class Projectile extends Player {
  ...
  // Méthode pour update la position du disque par ajout velocity aux coordonnées x et y 
  update() {
    this.draw();
...
//Déclarations des variables, des arrays
...
// Génération aléatoire des enemis et de leur provenance
function spawnEnemies() {
  setInterval(() => {
    ...
    // ajout d'un enemy dans enemies array
